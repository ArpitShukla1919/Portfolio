          ...
          <div className='space-y-4 '>
            ...
            <motion.div
              ...
              <div>
                ...
                <a className='text-base font-semibold text-white ' href="mailto:arpitshukla1901@gmail.com">arpitshukla1901@gmail.com</a>
                <br />
                {/* <a className='text-base font-semibold text-white ' href="mailto:sterner1920@gmail.com">sterner1920@gmail.com</a> */}
            ...
            <motion.div
              ...
              <div>
                ...
                <p className='text-base font-semibold text-white capitalize'>+91 9120105095</p>
            ...
            <motion.div
              ...
              <div>
                ...
                <p className='text-base font-semibold text-white capitalize'>Vinay Khand, Lucknow</p>
                <p className='text-base font-semibold text-white capitalize'>Uttar Pradesh</p>
          ...
          <div className='space-y-5'>
            ...
            >
              <a href="https://github.com/ArpitShukla1919" target="_blank" rel="noopener noreferrer">
                <div className='p-6 text-4xl text-white transition-all duration-300 rounded-full cursor-pointer lg:p-6 lg:text-4xl md:text-3xl md:p-5 bg-slate-700 hover:text-black hover:bg-white'>
                  <FaGithub />
                </div>
              </a>
